...
<Check>
  **Prerequisites** You must have a valid sandbox secret and publishable key to
  follow guide. Reach out to us at connect@withterminal.com to get access.
</Check>
...
4.  Exchange Public Token
    Exchange this public token for a long-lived connection token using [`POST /public-token/exchange.`](/api-reference/authentication/public-token)
